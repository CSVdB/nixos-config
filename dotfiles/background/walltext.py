...
curr_wall = curr_dir + "/" + "hemsworth.jpeg"
notes = "/home/nick/workflow/reviews/focus.md"

# --
text_color = "white"  # text color
size = "20"  # text size (real size depends on the scale factor of your wallpaper)
border = 20  # space around your text blocks
columns = 1  # (max) number of columns
n_lines = 100  # (max) number of lines per column
# --
